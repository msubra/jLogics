...
public class CopyOfModuleListWindow extends JInternalFrame {
	...
	public CopyOfModuleListWindow() {
		...
		remove.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int ret = JOptionPane.showConfirmDialog(CopyOfModuleListWindow.this,"Do you want to remove the module from the list","Confirm?" , JOptionPane.YES_NO_OPTION);
